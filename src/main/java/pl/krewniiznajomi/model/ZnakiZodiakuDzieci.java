...
@Entity
@Table(name = "znaki_zodiaku_dz")
@Immutable
public class ZnakiZodiakuDzieci {
    ...
    public ZnakiZodiakuDzieci() {
    }

    public ZnakiZodiakuDzieci(String id, String imie, String nazwisko, String znakZodiaku) {
        this.id = id;
        this.imie = imie;
